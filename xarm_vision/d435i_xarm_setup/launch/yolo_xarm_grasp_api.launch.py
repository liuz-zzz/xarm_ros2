...
# All rights reserved.
#
# YOLO-based grasping system launch file
# Author: AI Assistant
...
def launch_setup(context, *args, **kwargs):
    ...
    yolo_detector_node = Node(
        ...
        parameters=[
            yolo_config_file,
            {
                'target_classes': [yolo_target_class.perform(context)],
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('yolo_target_class', default_value='apple', description='YOLO目标类别'),
